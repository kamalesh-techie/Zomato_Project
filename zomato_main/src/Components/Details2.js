                ...
                >
                    <h2  className="menutittle">Menu Modal</h2>
                     <div className="menudetails">
                        ...
                        <button type="button" class="btn btn-danger" onClick={() => this.handleOder('menuItemModelIsOpen',false)}>Cancel</button>
                    </div>
                    <div className="menudetails">
                       <div className="count">
                          <button type="button" class="btn btn-success" onClick={() => this.removeItemHandler(restaurent.min_price)}> - </button>
                          <button type="button" class="btn btn-light"> {totalItem}</button>
                          <button type="button" class="btn btn-success" onClick={() => this.addItemHandler(restaurent.min_price)}> + </button>
                       </div>
                       <div className="totalamt"><h5>Total Amount : {totalPrice}</h5></div>
                       
                       <div className="paybutton">
                          <button  type="button" class="btn btn-primary" onClick={() => this.paymentHandler()}>Pay Now</button> 
                       </div>
                    </div>
