...
class Filter extends React.Component{
  ...
  axios({
    ...
    this.setState({ restaurentLocation : response.data.data.restaurent})
    //console.log(response.data.data.restaurent);
...
render(){
  const { restaurent, restaurentLocation, totalPage, page } = this.state;
  return(
        <div>
      ...
      <div className="col-sm-12 col-md-4 col-lg-3">
        <div className="filterPanel">
          ...
          <br></br>
          <input type="radio" className="cuisinOption" name="cost" onChange={() => this.handleCostChange(0, 50000)}/>
            <label>2000+</label>
